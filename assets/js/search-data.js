    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "Shorts",},{id: "shorts-посмотрел-по-рекомендации-друга-французский-фильм-хористы-2004г-всем-также-советую",
          title: 'Посмотрел, по рекомендации друга, французский фильм “Хористы” (2004г.). Всем также советую!',
          description: "",
          section: "Shorts",},];
